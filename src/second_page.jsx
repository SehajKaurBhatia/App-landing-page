...
return(
    <>
    <div className='box1'>
    <img className='phone4' src="/images/phone4.png"/>
    <img className="rings2"src="/images/rings2.png"/>
    <img className="el3"src="/images/el3.png"/>
    </div>
    <img className="star4"src="/images/Star 3.png"/>
    <div className='box2'>
    <p className='features'>FEATURES</p>
    <h1>Uifry Premium</h1>
    <p className='heading'><img className="icon5" src="/images/star2.png"/>Budgeting Intervals</p>
