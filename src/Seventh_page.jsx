    ...
    return(
        ...
        <div className='box12'>
            ...
            <div className="link">
                ...
                <p className='row1'>About Us</p>
                <p className='row2'>Bookings</p>
                <p className='row3'>Blog</p>
            </div>
            <div className='link'>
                <p className='col1'>Legal</p>
            <p className='home2'>Terms Of Use</p>
                <p className='row4'>Privacy Policy</p>
                <p className='row5'>Cookie Policy</p>
            </div>
            <div className='link'>
                <p className='col1'>Product</p>
            <p className='home3'>Take Tour </p>
                <p className='row6'>Live Chat</p>
                <p className='row7'>Reviews</p>
            </div>
            <div className='link'>
                <p className='col1'>Newsletter</p>
                <p className='home4'>Stay Up To Date</p>
